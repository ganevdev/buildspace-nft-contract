...
contract MyEpicNFT is ERC721URIStorage {
    ...
    returns (string memory)
  {
    ...
    uint256 rand = random(
      string(abi.encodePacked("Gandalf", Strings.toString(tokenId)))
    );
  ...
  {
    uint256 rand = random(
      string(abi.encodePacked("tasted", Strings.toString(tokenId)))
    );
  ...
  {
    uint256 rand = random(
      string(abi.encodePacked("Maiar", Strings.toString(tokenId)))
    );
